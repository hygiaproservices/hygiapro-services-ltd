...
const WHATSAPP_MESSAGE = encodeURIComponent("Hello, I'd like to inquire about your cleaning services.")
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="max-w-2xl">
              ...
              <p className="text-lg leading-relaxed text-primary-foreground/70">
                Have questions about our services? Want to schedule a consultation? We're here to help. Reach out and
        ...
        <section className="py-24 lg:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
              {/* Contact Info */}
              <div>
                <h2 className="mb-8 font-serif text-2xl font-medium text-foreground md:text-3xl">Get in Touch</h2>
                ...
                <div className="border border-border bg-secondary p-8">
                  ...
                  <h3 className="mb-2 text-lg font-semibold text-foreground">Prefer WhatsApp?</h3>
                  <p className="mb-4 text-sm text-muted-foreground">
                    Get instant responses and quick quotes through WhatsApp. Our team is ready to assist you.
                  </p>
                  <a
              ...
              {/* Contact Form */}
              <div>
                <h2 className="mb-8 font-serif text-2xl font-medium text-foreground md:text-3xl">Send a Message</h2>
                <ContactForm />
              </div>
            </div>
          </div>
