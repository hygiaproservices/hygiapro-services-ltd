    ...
    <section className="relative min-h-screen overflow-hidden bg-background">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl items-center px-6 pt-20 lg:px-8">
        <div className="max-w-2xl py-24 lg:py-32">
          ...
          >
            Experience cleaning elevated to an art form. We bring meticulous attention and premium care to every home
          ...
          >
            {[
              ...
              >
                <p className="font-serif text-3xl font-medium text-accent md:text-4xl">{stat.value}</p>
