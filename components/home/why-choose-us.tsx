        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
          ...
          <motion.div
            ...
            <div className="aspect-[4/5] overflow-hidden">
              <img
                src="/28059d5a9501679cb08c58b7cbbac13f.jpg"
          ...
          <motion.div
            ...
            <p className="mb-12 text-base leading-relaxed text-primary-foreground/70">
              We don't just clean spaces—we transform them. Our commitment to
              excellence, combined with premium products and trained
              professionals, ensures an experience that exceeds expectations.
            </p>
